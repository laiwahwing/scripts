...
#PROMPT='%{$FG[033]%}${SHORT_HOST:-$HOST}%{$reset_color%} %{$fg[magenta]%}[%c] %{$reset_color%}'
PROMPT='%{$FG[040]%}%n%{$reset_color%} %{$FG[239]%}at%{$reset_color%} %{$FG[033]%}${SHORT_HOST:-$HOST}%{$reset_color%} %{$fg[magenta]%}[%c] %{$reset_color%}'
